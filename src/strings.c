...
const u8 gText_BattleFactory[] = _("BATTLE TOWER");
...
const u8 gText_BattleFactoryKnowledgeSymbol[] = _("Gen 3 OU Emerald - Knowledge Symbol");
...
const u8 gText_BattleFactory2[] = _("BATTLE TOWER");
...
const u8 gText_BattleSwapSingleResults[] = _("{PLAYER}'s Gen 3 OU Emerald Single Results");
const u8 gText_BattleSwapDoubleResults[] = _("{PLAYER}'s Gen 3 OU Emerald Double Results");
